...
{
       0,    59,    59,    58,    64,    65,    66,    69,    70,    71,
      76,    75,    87,    90,    98,   106,   108,   110,   120,   129,
     138,   147,   156,   169,   174,   173,   193,   197,   192,   215,
     226,   233
};
#endif
...
{
  "$end", "error", "$undefined", "tMAIN", "tOB", "tCB", "tCP", "tNL",
  "tPLUS", "tMINUS", "tCROSS", "tDIV", "tEQU", "tCOMA", "tSC", "tINTEGER",
  "tIF", "tELSE", "tWHILE", "tOP", "tNAME", "tCONST", "tINT", "tPRINT",
  "$accept", "input", "$@1", "body", "line", "$@2", "declaration", "math",
  "bodif", "$@3", "while", "$@4", "$@5", "condition", "value", YY_NULLPTR
};
#endif
...
{
     -18,     0,     7,    -5,   -31,     4,     8,   -31,     5,     3,
     -31,    12,    13,    18,    20,    35,     5,    27,    25,   -31,
      -9,    24,    -7,    26,    32,    29,   -31,   -31,   -31,   -31,
     -31,   -31,    39,    38,    -9,    -7,    21,   -31,    40,    -7,
      41,    47,   -31,    42,    49,   -31,    -7,    -7,    -7,    -7,
      -7,    21,    43,     5,    52,    -9,   -31,    23,    23,   -31,
     -31,    21,   -31,    53,     5,   -31,    55,   -31,    56,     5,
     -31,    57,   -31
};
...
{
       0,     0,     0,     0,     1,     0,     0,     2,     6,     0,
      26,     0,     0,     0,     0,     0,     5,     0,     9,    12,
       0,     0,     0,     0,    15,     0,     3,     4,     7,    10,
      30,    31,     0,     0,     0,     0,    17,    23,    16,     0,
       0,     0,    24,     0,     0,    22,     0,     0,     0,     0,
       0,    13,     0,     6,     0,     0,    27,    20,    21,    18,
      19,    14,     8,     0,     6,    29,     0,    11,     0,     6,
      25,     0,    28
};
...
{
      27,    33,    35,     3,     1,    45,    30,     4,    30,    51,
       6,    31,     7,    31,     5,    33,    57,    58,    59,    60,
      61,     9,    20,    10,    22,    11,    12,    13,    14,    46,
      47,    48,    49,    48,    49,    23,    65,    63,    24,    25,
      26,    28,    29,    34,    39,    42,    38,    52,    68,    40,
      43,    53,    50,    71,    55,    56,    64,    62,    67,    69,
       0,    70,    72,     0,    44
};

static const yytype_int8 yycheck[] =
{
      16,    20,     9,     3,    22,    35,    15,     0,    15,    39,
       6,    20,     4,    20,    19,    34,    46,    47,    48,    49,
      50,    16,    19,    18,    12,    20,    21,    22,    23,     8,
       9,    10,    11,    10,    11,    22,    55,    53,    20,    19,
       5,    14,    17,    19,    12,     6,    20,     6,    64,    20,
      12,     4,    12,    69,    12,     6,     4,    14,     5,     4,
      -1,     5,     5,    -1,    34
};
...
{
       0,    22,    25,     3,     0,    19,     6,     4,    26,    16,
      18,    20,    21,    22,    23,    27,    28,    30,    32,    34,
      19,    35,    12,    22,    20,    19,     5,    27,    14,    17,
      15,    20,    37,    38,    19,     9,    31,    38,    20,    12,
      20,    29,     6,    12,    37,    31,     8,     9,    10,    11,
      12,    31,     6,     4,    33,    12,     6,    31,    31,    31,
      31,    31,    14,    27,     4,    38,    36,     5,    27,     4,
       5,    27,     5
};
...
{
       0,    24,    26,    25,    27,    27,    27,    28,    28,    28,
      29,    28,    28,    30,    30,    30,    30,    30,    31,    31,
      31,    31,    31,    31,    33,    32,    35,    36,    34,    37,
      38,    38
};
...
#line 72 "gram.y" /* yacc.c:1646  */
    {
                        patch((yyvsp[0].intValue), current_ligne);
                        }
...
#line 76 "gram.y" /* yacc.c:1646  */
    {
                        patch((yyvsp[-1].intValue), current_ligne+1);
                        instruct inst={"JMP",-1,-1,-1};
                        labels[current_ligne]=inst;
                        current_ligne++;
                        (yyvsp[-1].intValue)=current_ligne-1;
                        }
...
#line 84 "gram.y" /* yacc.c:1646  */
    {
                        patch((yyvsp[-5].intValue),current_ligne);
                        }
...
#line 174 "gram.y" /* yacc.c:1646  */
    {printf("debut if \n"); 
                        ...
                        labels[current_ligne]=inst;
                        current_ligne++;
                        (yyvsp[-3].intValue) = current_ligne-1;
                        }
...
#line 193 "gram.y" /* yacc.c:1646  */
    {
                                (yyvsp[0].intValue)=current_ligne;
                        }
...
#line 197 "gram.y" /* yacc.c:1646  */
    {
                                ...
                                instruct inst={"JMF",k,-1,-1};
                                labels[current_ligne]=inst;
                                (yyvsp[-2].intValue) = current_ligne;
                                current_ligne++;
                        }
...
#line 227 "gram.y" /* yacc.c:1646  */
    {printf("int %d \n",yylval.intValue) ; 
                int i=pushtemp();
                instruct inst={"AFC",i,(yyvsp[0].intValue),-1};
                labels[current_ligne]=inst;
                current_ligne++;
                }
